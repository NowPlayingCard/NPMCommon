 ...
 */
exports.default = (function (Data, Key) { return __awaiter(void 0, void 0, void 0, function () {
    var Vector, _a, _b, _c, _d;
    var _e;
    return __generator(this, function (_f) {
        switch (_f.label) {
            case 0:
                ...
                return [4 /*yield*/, crypto.subtle.importKey("jwk", {
                        kty: "oct",
                        k: Key,
                        alg: "A256GCM",
                        ext: true,
            ...
            case 1: return [4 /*yield*/, _c.apply(_b, _d.concat([_f.sent(), node_buffer_1.Buffer.from(JSON.stringify(Data)).buffer]))];
            case 2: return [2 /*return*/, (_e.Data = new (_a.apply(Uint8Array, [void 0, _f.sent()]))(),
                    _e)];
        }
    });
}); });
