 ...
 */
exports.default = (function (Data, Key, Vector) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, _b, _c, _d;
    return __generator(this, function (_e) {
        switch (_e.label) {
            case 0:
                _a = Uint8Array.bind;
                _c = (_b = crypto.subtle).decrypt;
                _d = [{
                        name: "AES-GCM",
                        iv: Vector,
                        tagLength: 128,
            ...
            case 1: return [4 /*yield*/, _c.apply(_b, _d.concat([_e.sent(), Data]))];
